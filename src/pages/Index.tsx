      ...
      <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center hero-gradient py-16 md:py-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Uw partner voor afbraakprojecten, grondwerken en containers van
              11m³ tot 28m³.
            </motion.p>
            <motion.div
            ...
            >
              <Button
                ...
                asChild
              >
                <Link to="/containerverhuur">Container Huren</Link>
              </Button>
              <Button
                variant="heroOutline"
                size="xl"
            ...
            {[
              ...
              <StaggerItem key={index}>
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  {/* Afbeelding gelinkt aan de service.image property */}
                  <div className="relative h-56 mb-8 overflow-hidden rounded-sm border border-border bg-muted">
                    <img
                      src={service.image}
                      alt={service.title}
                  ...
                  <ul className="space-y-3 mb-8">
                    {service.items.map((item, i) => (
                      <li
                        key={i}
                        className="flex items-center gap-3 text-card-foreground text-sm font-medium"
                      >
            ...
            <FadeInView direction="left" className="relative">
              <div className="relative z-10">
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-6 max-w-xl leading-relaxed">
                  Wat in 1981 begon als een kleine ruimdienst, is onder leiding
                  van de familie Devoogt uitgegroeid tot een volwaardige partner
                  in grond- en afbraakwerken.
                </p>
                <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-xl leading-relaxed">
                  Vandaag bereiden we ons voor op de toekomst met de overdracht
                  naar de nieuwe generatie: William en Stefanie Devoogt.
                </p>
                <Button
                  variant="hero"
                  size="lg"
              ...
              <div className="bg-card border border-border p-2 md:p-3 overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 bg-primary p-4 md:p-6 shadow-xl transform translate-y-4 opacity-0 group-hover:opacity-100 transition-all duration-500 hidden md:block">
                  <p className="text-background font-display text-sm md:text-lg uppercase italic leading-tight text-center">
                    "Vakkundigheid en passie voor het vak, van generatie op
                    generatie."
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <FadeInView className="max-w-3xl mx-auto">
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-8">
              Neem vandaag nog contact met ons op voor een vrijblijvende
              offerte. Wij komen graag langs om uw project te bespreken.
            </p>
